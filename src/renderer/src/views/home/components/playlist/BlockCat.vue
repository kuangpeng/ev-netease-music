      ...
      <div class="catlist-content">
        <n-el>
          <div class="all c-sec">
            <span
              class="cat-link"
              :class="{ active: selectedCat == catList.all?.name }"
              @click="handleChooseCat(catList.all?.name || '')"
              >{{ catList.all?.name }}</span
            >
          </div>
          ...
          <div class="catlist-ul">
            <div v-for="(item, index) in catList.cats" :key="index" class="list-item">
              ...
              <div class="ul-b">
                <div class="c-sec">
                  <div v-for="c in item.cats" :key="c.name" class="g-i">
                    <span
                      class="cat-link"
                      :class="{ active: selectedCat == c.name }"
                      @click="handleChooseCat(c.name)"
                    >
                      {{ c.name }}
                      <i v-if="c.hot">HOT</i>
                    </span>
